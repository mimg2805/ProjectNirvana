...
function BaseState:touchpressed(id, x, y, dx, dy, pressure) end
function BaseState:touchreleased(id, x, y, dx, dy, pressure) end
function BaseState:touchmoved(id, x, y, dx, dy, pressure) end